...
- **Excel** — interactive dashboard and KPIs  

This README follows industry-standard best practices with:  
✔ Clean structure  
✔ Embedded key visuals  
✔ Clickable links for all assets  
✔ MIT License section  
...
You are free to **use, modify, distribute, and integrate** this project as long as copyright notice is maintained.
